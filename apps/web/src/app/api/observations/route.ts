...
import {
  acceptObservation,
  processObservationInBackground,
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("[api/observations] failed to accept observation:", err);
    return NextResponse.json({ error: "Could not accept observation." }, { status: 500 });
  }
}
